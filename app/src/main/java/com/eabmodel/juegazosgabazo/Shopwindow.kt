...
class Shopwindow: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dbController.createProduct("EA SPORTS FIFA 21 Deluxe Edition", "Games_codes", "Play Station", "Key", "FIFA 21 is a football (soccer) sports game developed by EA Vancouver and published by EA Sports. The game is yet another installment of classic football simulation series, dating back to the late nineties of the last century. In FIFA21, the player will once again play as their favorite team, participating in matches with other players through online multiplayer or against the computer offline. The video game offers improvements to its various modes, including FIFA Ultimate Team, Volta, and Career modes. Gameplay mechanics have also been revamped, offering even more intuitive controls. FIFA 21 was received positively by the critics, who praised improved gameplay mechanics, additional players I FUT mode, and demanding Career mode.", 21.50, R.drawable.por6)

         */


        recyclerViewShopwindow = findViewById(R.id.recyclerViewShopwindow)
        var listOfProducts = dbController.orderProductsByTitle()

        var adapter = ShopwindowAdapter(this, listOfProducts )
        ...
        adapter.setOnProductClickListener {
            ...
            Toast.makeText(this, " ${it.title} was addded", Toast.LENGTH_SHORT).show()
        }
        ...
        steamButton.setOnClickListener{
            ...
            recyclerViewShopwindow.adapter = adapter
            recyclerViewShopwindow.layoutManager = LinearLayoutManager(this)
            adapter = ShopwindowAdapter(this, dbController.orderProductsByPlatform("Steam"))
        }
        psButton.setOnClickListener{
            ...
            recyclerViewShopwindow.adapter = adapter
            recyclerViewShopwindow.layoutManager = LinearLayoutManager(this)
            adapter = ShopwindowAdapter(this, dbController.orderProductsByPlatform("Play Station"))
        }
